...
public class FindFirstTaskOperation() : GraphQLOperation( "query" ) {
  ...
  public var distinct: List<TaskScalarFieldEnum>? = null
    set(`value`) {
      fieldSet+="distinct"
          field = value
  ...
  public constructor(block: FindFirstTaskOperation.() -> Unit) : this() {
    val operation = FindFirstTaskOperation().apply(block)
