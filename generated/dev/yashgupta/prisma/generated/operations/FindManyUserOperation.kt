...
public class FindManyUserOperation() : GraphQLOperation( "query" ) {
  ...
  public constructor(block: FindManyUserOperation.() -> Unit) : this() {
    val operation = FindManyUserOperation().apply(block)
