...
public class FindFirstUpdateOperation() : GraphQLOperation( "query" ) {
  ...
  public constructor(block: FindFirstUpdateOperation.() -> Unit) : this() {
    val operation = FindFirstUpdateOperation().apply(block)
