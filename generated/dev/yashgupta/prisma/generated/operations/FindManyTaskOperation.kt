...
public class FindManyTaskOperation() : GraphQLOperation( "query" ) {
  ...
  public constructor(block: FindManyTaskOperation.() -> Unit) : this() {
    val operation = FindManyTaskOperation().apply(block)
